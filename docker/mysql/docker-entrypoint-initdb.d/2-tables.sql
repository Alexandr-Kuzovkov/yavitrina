...
CREATE TABLE IF NOT EXISTS `review` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(255) NULL DEFAULT NULL,
  `dignity` TEXT NULL DEFAULT NULL,
  `flaw` TEXT NULL DEFAULT NULL,
  `grade` INT NULL DEFAULT NULL,
  `product_id` INT NULL DEFAULT NULL,
  `date` DATETIME NULL DEFAULT NULL,
  `image` TEXT NULL DEFAULT NULL,
  `comment` TEXT NULL DEFAULT NULL,
  `use_experince` TEXT NULL DEFAULT NULL,
...
# For each column:
ALTER TABLE review CHANGE dignity dignity TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE review CHANGE flaw flaw TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE review CHANGE grade grade TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE review CHANGE comment comment TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE review CHANGE use_experince use_experince TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
